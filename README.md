...
**IFConnected** é uma plataforma de rede social desenvolvida para conectar estudantes de diferentes campus do Instituto Federal da Paraiba.

Diferente de redes sociais genéricas, o **IFConnected** utiliza inteligência geográfica (**PostGIS**) para conectar alunos que estudam no mesmo campus ou em unidades próximas, facilitando a organização de eventos acadêmicos, publicações e mais.

O projeto foi construído como um estudo de **Arquitetura de Software**, implementando o conceito de **Persistência Poliglota**, onde diferentes bancos de dados resolvem problemas específicos de performance e escalabilidade.
...
_Isso iniciará: Postgres (5432), Mongo (27017), Redis (6379) e MinIO (9000/9001)._
...
_O Backend rodará em `http://localhost:8080`. As tabelas e dados iniciais serão criados automaticamente pelo `DataSeeder`._
...
O Frontend foi construído focando em uma experiência **Mobile-First** e **Minimalista**, inspirada no antigo Twitter/X.
...
<div align="center">
  <sub>Desenvolvido por Jorge Allan e Paulo - IFPB</sub>
</div>
```
